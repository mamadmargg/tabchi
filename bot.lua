...
elseif text:match("^خارج شدن از سوپرگروه ها") then 
				...
				tdcli_function({ID="GetMe",},lkj, nil)
									return send(msg.chat_id_, msg.id_, "<i>ربات درحال خارج شدن از تمامی سوپرگروه ها میباشد !</i>")
							elseif text:match("^خارج شدن از گروه ها") then 
					   function lkj(arg, data) 
						bot_id=data.id_ 
				...
				tdcli_function({ID="GetMe",},lkj, nil)
									return send(msg.chat_id_, msg.id_, "<i>ربات در حال خارج شدن از تمامی گروه ها میباشد !</i>")
